...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey,           }, "g", function () awful.util.spawn("google-chrome-beta") end),
    awful.key({ modkey,           }, "t", function () awful.util.spawn("thunderbird-bin") end),
    awful.key({ modkey,           }, "x", function () awful.util.spawn("xchat") end),
    awful.key({ modkey,           }, "f", function () awful.util.spawn("firefox-bin") end),
    awful.key({ modkey,           }, "p", function () awful.util.spawn("pavucontrol") end),
    awful.key({ modkey,           }, "m", function () awful.util.spawn("xterm -e alsamixer -c 0") end),
...
awful.util.spawn_with_shell("/home/bazi/.init-wm.sh")
